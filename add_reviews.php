...
<body>
   ...
   <div class="container">
        <div class="row">
          ...
          <form  method="POST" action="add_review_backend.php">
						<div class="row">
							<div class="col-md-12">
                            ...
                            <div class="col-md-12">
								<div class="form-group">
                                    <p>Review</p>
									<textarea name="msg" id="msg" cols="30" rows="10" class="form-control">Write your review here !</textarea>
									<div class="help-block with-errors"></div>
								</div>                                 
							</div>
							...
							<div class="col-md-12">
								<div class="submit-button text-center">
									...
									<button class="btn btn-common" id="submit" name="add_review" type="submit">Add</button>
